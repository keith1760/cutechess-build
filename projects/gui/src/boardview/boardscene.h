...
class BoardScene : public QGraphicsScene
{
	...
	public:
		...
		/*!
		 * Returns true if the board is currently flipped, i.e.
		 * the side that started at the bottom of the screen is
		 * now at the top (and vice versa).
		 */
	...
	signals:
		...
		/*!
		 * Emitted whenever the board's flipped state changes
		 * (e.g. via flip()). \a isFlipped is the new state.
		 */
		void flipped(bool isFlipped);
